...
resource "hcloud_storage_box_subaccount" "backup" {
  ...
  storage_box_id = var.backup_storage_box_id

  name           = "backup-${var.project_name}-${var.environment_name}-${var.server_name}"
  description    = "Managed by Terraform"
  home_directory = "${var.project_name}/${var.environment_name}/${var.server_name}"
